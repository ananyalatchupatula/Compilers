...
void TAC_Generator::reset_counters() {
    temp_counter = 0;
    stemp_counter = 0;
    // NOTE: label_counter, string_counter, and string_label_map are NOT reset
    // Labels and strings should be globally unique across all functions in a compilation unit
    // label_counter = 0;
    // string_counter = 0;
    // string_label_map.clear();
}

void TAC_Generator::reset_label_counter() {
    label_counter = 0;
}
