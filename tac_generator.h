...
public:
    ...
    uint32_t get_string_counter() { return string_counter; }
    
    void set_temp_counter(uint32_t val) { temp_counter = val; }
    void set_stemp_counter(uint32_t val) { stemp_counter = val; }
};
